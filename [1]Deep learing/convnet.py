...
conv2 = tf.layers.conv2d(pooling1,32,(3,3),padding='same',activation=tf.nn.relu,name='conv2')# 32:输出通道的数目;(3,3):kernel size卷积核的大小;activation:激活函数
...
conv3 = tf.layers.conv2d(pooling2,32,(3,3),padding='same',activation=tf.nn.relu,name='conv3')# 32:输出通道的数目;(3,3):kernel size卷积核的大小;activation:激活函数
